...
function Forms() {
  return (
    <div id='form'>
      ...
      <br />
      <br />
      <h3 className='subject'  data-aos="zoom-in-up" data-aos-duration="2500">Wanna Make Your Poster?</h3>


      <div
        className="container d-flex justify-content-center align-items-center" style={{ height: "100vh", marginTop: '-18em' }}>
        <form className='inp'>
